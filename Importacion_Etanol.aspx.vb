...
Partial Class Importacion_Etanol
    ...
    Private tabla6 As String = "SINOXCarga006_ImportacionEtanol"
    Private u6 As Integer = 1
    ...
    Public Sub Resalta_Textbox()
        Dim txt() As TextBox = {txtMT, txtMDB}
    ...
    Protected Sub dropAño_PreRender(sender As Object, e As System.EventArgs) Handles dropAño.PreRender
        ...
        Try
            Using cnn As New SqlConnection(CadenaConexionPrueba)
                ...
                cmd_año.Parameters.Add("@TABLA_CONSULTA", SqlDbType.NVarChar).Value = tabla6
    ...
    Protected Sub dropMes_PreRender(sender As Object, e As System.EventArgs) Handles dropMes.PreRender
        ...
        Try
            Using cnn As New SqlConnection(CadenaConexionPrueba)
                ...
                cmd_mes.Parameters.Add("@TABLA_CONSULTA", SqlDbType.NVarChar).Value = tabla6
        ...
        End Try
    End Sub
    REM en el caso especifico de los textbox de factor, dias y densidad siempre son los mismos por eso los prerendeizo 
    Protected Sub txtFactor_TextChanged(sender As Object, e As System.EventArgs) Handles txtFactor.PreRender
        txtFactor.Text = "158.987304"
    End Sub

    Protected Sub txtDias_TextChanged(sender As Object, e As System.EventArgs) Handles txtDias.PreRender
        txtDias.Text = "30"
    End Sub

    Protected Sub txtDensidad_TextChanged(sender As Object, e As System.EventArgs) Handles txtDensidad.PreRender
        txtDensidad.Text = "0.358"
    End Sub
    ...
    Protected Sub editar_Click(sender As Object, e As System.Web.UI.ImageClickEventArgs) Handles editar.Click
        Try
            Using con As New SqlConnection(CadenaConexionPrueba)
                ...
                cmd_recupera_registro.Parameters.Add("@TABLA_CONSULTA", SqlDbType.NChar).Value = tabla6
                ...
                txtMT.Text = Convert.ToInt32(dtr.Rows(0)(2))
                txtMDB.Text = Convert.ToInt32(dtr.Rows(0)(3))
                txtDensidad.Text = Convert.ToInt32(dtr.Rows(0)(4))
                txtFactor.Text = Convert.ToInt32(dtr.Rows(0)(5))
                txtDias.Text = Convert.ToInt32(dtr.Rows(0)(6))
    ...
    Protected Sub btn_edit_Click(sender As Object, e As System.Web.UI.ImageClickEventArgs) Handles btn_edit.Click
        Try
            Using con_editar_recuperado As New SqlConnection(CadenaConexionPrueba)
                ...
                cmd_editar_recuperado.Parameters.Add("@ETANOL_MT", SqlDbType.Int).Value = Convert.ToDecimal(txtMT.Text)
                cmd_editar_recuperado.Parameters.Add("@ETANOL_MDB", SqlDbType.Int).Value = Convert.ToDecimal(txtMDB.Text)
                cmd_editar_recuperado.Parameters.Add("@DENSIDAD", SqlDbType.Decimal).Value = Convert.ToDecimal(txtDensidad.Text)
                cmd_editar_recuperado.Parameters.Add("@FACTOR", SqlDbType.Decimal).Value = Convert.ToDecimal(txtFactor.Text)
                cmd_editar_recuperado.Parameters.Add("@DIAS", SqlDbType.Int).Value = Convert.ToInt32(txtDias.Text)
                cmd_editar_recuperado.Parameters.Add("@UNIDAD_DE_MEDIDA", SqlDbType.Int).Value = Convert.ToInt32(u6)
                cmd_editar_recuperado.CommandText = "usp_SINO_UPDATE_ImportacionEtanol"
    ...
    Protected Sub add_Click(sender As Object, e As System.Web.UI.ImageClickEventArgs) Handles add.Click
        Try
            Using con_add As New SqlConnection(CadenaConexionPrueba)
                ...
                cmd_add.Parameters.Add("@ETANOL_MT", SqlDbType.Int).Value = Convert.ToInt32(txtMT.Text)
                cmd_add.Parameters.Add("@ETANOL_MDB", SqlDbType.Int).Value = Convert.ToInt32(txtMDB.Text)
                cmd_add.Parameters.Add("@DENSIDAD", SqlDbType.Decimal).Value = Convert.ToDecimal(txtDensidad.Text)
                cmd_add.Parameters.Add("@FACTOR", SqlDbType.Decimal).Value = Convert.ToDecimal(txtFactor.Text)
                cmd_add.Parameters.Add("@DIAS", SqlDbType.Int).Value = Convert.ToInt32(txtDias.Text)
                cmd_add.Parameters.Add("@UNIDAD_DE_MEDIDA", SqlDbType.Int).Value = Convert.ToInt32(u6)
                cmd_add.CommandText = "usp_SINO_NuevoRegistro_ImportacionEtanol"
                con_add.Open()
