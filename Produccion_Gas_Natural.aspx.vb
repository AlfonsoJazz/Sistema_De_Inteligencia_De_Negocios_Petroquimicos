...
Partial Class Produccion_Gas_Natural
    ...
    Private tabla2 As String = "SINOXCarga002_ProduccionGasNatual"
    'u = unidad de medida
    Private u2 As Integer = 2
    ...
    Protected Sub dropAño_PreRender(sender As Object, e As System.EventArgs) Handles dropAño.PreRender
        ...
        Try
            Using cnn As New SqlConnection(CadenaConexionPrueba)
                ...
                cmd_año.Parameters.Add("@TABLA_CONSULTA", SqlDbType.NVarChar).Value = tabla2
    ...
    Protected Sub dropMes_PreRender(sender As Object, e As System.EventArgs) Handles dropMes.PreRender
        ...
        Try
            Using cnn As New SqlConnection(CadenaConexionPrueba)
                ...
                cmd_mes.Parameters.Add("@TABLA_CONSULTA", SqlDbType.NVarChar).Value = tabla2
    ...
    Protected Sub editar_Click(sender As Object, e As System.Web.UI.ImageClickEventArgs) Handles editar.Click
        Try
            Using con As New SqlConnection(CadenaConexionPrueba)
                ...
                cmd_recupera_registro.Parameters.Add("@TABLA_CONSULTA", SqlDbType.NChar).Value = tabla2
                ...
                txtaHidrocarburo.Text = Convert.ToInt32(dtr.Rows(0)(3))
                txtaNitrogeno.Text = Convert.ToInt32(dtr.Rows(0)(4))
                txtNA.Text = Convert.ToInt32(dtr.Rows(0)(5))
                txtAguas.Text = Convert.ToInt32(dtr.Rows(0)(6))
                txtSur.Text = Convert.ToInt32(dtr.Rows(0)(7))
                txtNorte.Text = Convert.ToInt32(dtr.Rows(0)(8))
    ...
    Protected Sub btn_edit_Click(sender As Object, e As System.Web.UI.ImageClickEventArgs) Handles btn_edit.Click
        Try
            Using con_editar_recuperado As New SqlConnection(CadenaConexionPrueba)
                ...
                cmd_editar_recuperado.Parameters.Add("@A_HIDROCARBURO", SqlDbType.Decimal).Value = Convert.ToDecimal(txtaHidrocarburo.Text)
                cmd_editar_recuperado.Parameters.Add("@A_NITROGENO", SqlDbType.Decimal).Value = Convert.ToDecimal(txtaNitrogeno.Text)
                cmd_editar_recuperado.Parameters.Add("@NO_ASOCIADO", SqlDbType.Decimal).Value = Convert.ToDecimal(txtNA.Text)
                cmd_editar_recuperado.Parameters.Add("@AGUAS_SOMERAS", SqlDbType.Decimal).Value = Convert.ToDecimal(txtAguas.Text)
                cmd_editar_recuperado.Parameters.Add("@SUR", SqlDbType.Decimal).Value = Convert.ToDecimal(txtSur.Text)
                cmd_editar_recuperado.Parameters.Add("@NORTE", SqlDbType.Decimal).Value = Convert.ToDecimal(txtNorte.Text)
                'cmd_editar_recuperado.Parameters.Add("@LIQ_GAS", SqlDbType.Decimal).Value = Convert.ToDecimal(txtLiquidoGas.Text)
                cmd_editar_recuperado.Parameters.Add("@UNIDAD_MEDIDA", SqlDbType.Decimal).Value = Convert.ToInt32(u2)
                cmd_editar_recuperado.CommandText = "usp_SINO_UPDATE_ProduccionGasNatual"
    ...
    Protected Sub add_Click(sender As Object, e As System.Web.UI.ImageClickEventArgs) Handles add.Click
        Try
            Using con_add As New SqlConnection(CadenaConexionPrueba)
                ...
                cmd_add.Parameters.Add("@A_HIDROCARBURO", SqlDbType.Decimal).Value = Convert.ToDecimal(txtaHidrocarburo.Text)
                cmd_add.Parameters.Add("@A_NITROGENO", SqlDbType.Decimal).Value = Convert.ToDecimal(txtaNitrogeno.Text)
                cmd_add.Parameters.Add("@NO_ASOCIADO", SqlDbType.Decimal).Value = Convert.ToDecimal(txtNA.Text)
                cmd_add.Parameters.Add("@AGUAS_SOMERAS", SqlDbType.Decimal).Value = Convert.ToDecimal(txtAguas.Text)
                cmd_add.Parameters.Add("@SUR", SqlDbType.Decimal).Value = Convert.ToDecimal(txtSur.Text)
                cmd_add.Parameters.Add("@NORTE", SqlDbType.Decimal).Value = Convert.ToDecimal(txtNorte.Text)
                'cmd_add.Parameters.Add("@LIQ_GAS", SqlDbType.Decimal).Value = Convert.ToDecimal(txtLiquidoGas.Text)
                cmd_add.Parameters.Add("@UNIDAD_MEDIDA", SqlDbType.Decimal).Value = Convert.ToInt32(u2)
                cmd_add.CommandText = "usp_SINO_NuevoRegistro_ProduccionGasNatual"
                con_add.Open()
